...
type TauriCommands = {
	...
	'start_capture_stream': {args: {windowName: WindowName, fps: number, size: number, format: IColor["format"]}; return: void}
	...
	'capture_cursor_area': {args: {x: number, y: number, size: number, format: IColor["format"]}; return: PipetteCapture}
}
